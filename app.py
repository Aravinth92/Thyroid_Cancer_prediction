...
model = pickle.load(open(os.path.join(MODEL_DIR, "thyroid_model.pkl"), "rb"))
columns = pickle.load(open(os.path.join(MODEL_DIR, "model_columns.pkl"), "rb"))
...
def predict():
    ...
    return render_template("index.html", prediction_text=result, submitted=True)
